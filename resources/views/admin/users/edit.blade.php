            ...
            <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-soft-gray overflow-hidden">
                ...
                <div class="p-4 sm:p-6">
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-semibold text-primary mb-2">Unit Kerja <span class="text-secondary/60 font-normal text-xs ml-1">(Opsional untuk Admin tanpa unit)</span></label>
                            <div class="relative">
                            ...
                            <p class="text-xs text-secondary/60 mt-1">Pilih unit kerja yang sesuai dengan peran pengguna</p>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateDropdown() {
        ...
        // Operator: Kaur, Kasi
        // Viewer: Kepala Desa, Kepala Dusun
        const adminKeywords = ['sekretaris desa'];
        const operatorKeywords = ['kaur', 'kasi'];
        const viewerKeywords = ['kepala desa', 'kepala dusun'];
        ...
        originalOptions.forEach(opt => {
            ...
            if (selectedRoleText.includes('operator')) {
                ...
                if (adminKeywords.some(kw => unitName.includes(kw))) show = true;
            }
